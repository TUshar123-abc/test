...
export const createContact = async (req, res) => {
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: 'staff.manasvi@gmail.com', // Your email address
        pass: 'ufbnyfxdwfygdksq',    // Your email password or app-specific password
      },
      tls: {
    ...
    const mailOptions = {
      ...
      to: 'staff.manasvi@gmail.com', // Recipient's email address
